...
db.getCollection("posts").insert([ {
    _id: ObjectId("60ba780acdf20e0ce42cc629"),
    "category_id": "60b4f367705ba95c4813c999",
    category: "Article",
    title: "sdfsfda",
    content: "<p>sdfsadfas</p>\r\n",
    poster: "dsfgdsfg",
    "poster_id": "60b63a7ad2a7ea368cf9cf0a",
    "poster_email": "sdf@mil.ru",
    "poster_phone": "452352325",
    "created_at": ISODate("2021-06-04T18:59:22.621Z"),
    like: NumberInt("0"),
    dislike: NumberInt("0"),
    images: "post_60b63a7ad2a7ea368cf9cf0a_202154115922.jpg",
    __v: NumberInt("0")
} ]);
db.getCollection("posts").insert([ {
    _id: ObjectId("60ba7c68fcb5e21908a67623"),
    "category_id": "60b4f367705ba95c4813c999",
    category: "Article",
    title: "adfsdf",
    content: "<p>sdfsdfsdfasd</p>\r\n",
    poster: "Maksim",
    "poster_id": "60b7c2a8f2667e2ea4ca3a2e",
    "poster_email": "maksim@gmail.com",
    "poster_phone": "1548742121",
    "created_at": ISODate("2021-06-04T19:18:00.139Z"),
    like: NumberInt("0"),
    dislike: NumberInt("0"),
    images: "post_60b7c2a8f2667e2ea4ca3a2e_20215412180.jpg",
    __v: NumberInt("0")
} ]);
db.getCollection("posts").insert([ {
    _id: ObjectId("60ba7ca9fcb5e21908a67624"),
    "category_id": "60b4f367705ba95c4813c999",
    category: "Article",
    title: "sdfsdf",
    content: "<p>sadfsadfads</p>\r\n",
    poster: "dfgds",
    "poster_id": "60b7c2a8f2667e2ea4ca3a2e",
    "poster_email": "maksim@gmail.com",
    "poster_phone": "43532532",
    "created_at": ISODate("2021-06-04T19:19:05.318Z"),
    like: NumberInt("0"),
    dislike: NumberInt("0"),
    images: "post_60b7c2a8f2667e2ea4ca3a2e_20215412195.jpg",
    __v: NumberInt("0")
} ]);
...
db.getCollection("users").insert([ {
    ...
    "created_at": ISODate("2021-06-04T11:44:46.162Z"),
    permission: NumberInt("2"),
